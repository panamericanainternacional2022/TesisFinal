...
### SE IMPLEMENTÓ UN SISTEMA DE FILTRADO POR EDIFICIO PARA EL APARTADO DE NOTIFICACIONES

### SE IMPLEMENTO UN SISTEMA DE DETECCION DE LA `app27.py` DESDE EL FRONTEND PARA VERIFICAR SI ESTÁ ACTIVO, INACTIVADO; UN BOTÓN DE APAGADO, ENCENDIDO Y REINICIO (SE TOMO EN CUENTA BUENA UX/UI TANTO PARA ADMIN COMO PARA USERS)

### ESTANDARIZACIÓN DE HEADERS, TITULOS EN SIDEBAR Y <TITLE> EN SU TOTALIDAD (TEMPLATES, `app27.py`, PDF)

### SE CORRIGIÓ FALLA DE LÓGICA DE NOTIFICACIONES, NO APUNTABA A NINGÚN ID, NO SE GUARDABA EN LA BD

### SE ELIMINÓ EL APARTADO DE NOTIFICACIONES DEL SIMULADOR Y SE TRASLADÓ COMPLETAMENTE AL APARTADO DE NOTIFICACIONES DEL SISTEMA CON TODAS SUS ACCIONES; SE GUARDÓ TOKEN DE INICIO DE SESIÓN PARA DESACTIVAR LAS NOTIFICACIONES INCLUSO CON LA SESIÓN CERRADA

### SE ELIMINÓ EL APARTADO DE SELECCIONAR MANUALMENTE DESDE EL SIMULADOR LOS EDIFICIOS PARA EL ENVIO DE CORREO, SE REALIZADO UN TRABAJO EN EL BACKEND PARA PERMITIR PODER MANIPULARLOS DESDE EL `monitoreo_admin.html`