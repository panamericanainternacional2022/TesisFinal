...
* Se redujo drásticamente el flujo constante de alertas espaciando el ciclo de simulación y el stream de eventos a 5 segundos. También se ajustó la probabilidad de fallos aleatorios a un nivel realista de simulación para evitar la saturación de alertas (2%), y se optimizó la interfaz web para que solo dibuje las últimas 30 lecturas del historial, resolviendo de forma definitiva los cuelgues del navegador.