...
# Las fallas se generan aleatoriamente durante update_sensor_data()
# y son manejadas por protección por dispositivo.
...
# update_sensor_data(), check_motor_stuck() y reset_critical_values()
# fueron movidos a simulation.py
